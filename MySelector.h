...
// Mon Jan 19 14:23:30 2026 by ROOT version 6.36.06
...
public :
   ...
   TTreeReaderValue<Float_t> Potential = {fReader, "Potential"};
   TTreeReaderValue<Float_t> Current = {fReader, "Current"};
   TTreeReaderValue<Float_t> Temperature = {fReader, "Temperature"};
   TTreeReaderValue<Float_t> Pressure = {fReader, "Pressure"};
